...
rel_ab_modified_2$Genus[rel_ab_modified_2$OTU %in% to_change_2] = '<1%'
unique(rel_ab_modified_2$Genus)
...
avg_modified_2$Genus[avg_modified_2$OTU %in% to_change_2] = '<1%'
...
# Saving plot
ggsave('Aim 1 - Grouped Bar Plots (Genus).jpeg', plot = plot_avg_2, height=8, width = 10)

```

```{r Making a Phylum Level plot}
...
# Saving plot
# ggsave('Aim 1 - Grouped Bar Plots (Phylum).jpeg', plot = plot_avg, height=8, width = 6)
