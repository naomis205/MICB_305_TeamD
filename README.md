...
-   Core microbiome
    ...
    -   done by genus -\> keep it as genus
...
-   Shannon alpha diversity
    ...
    -   MDS2: overlay LI dots on top of No_LI b/c there are fewer LI
        points than NDR
...
-   Conclusions:
    ...
    -   Replicated previous findings:
        ...
        -   found no alpha diversity,

        -   found beta diversity
    ...
    -   Core microbiome:
        ...
        -   look into what some species are... if interesting, could
            report?
